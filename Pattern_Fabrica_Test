...
что то вроде вышло. Хотя впринцепе можно было возвращать объект сотрудника 
$Pekar = new Sotrydnik('Булочник','Печь булки','10 руб булочка'), но тогда не было бы делигирования создания самого класса,
другому классу.
*/
